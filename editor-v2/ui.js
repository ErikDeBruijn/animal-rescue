...
editor.updateAnimalCheckboxes = function() {
    ...
    document.getElementById('animal-squirrel').checked = 
        editor.state.editingLevel.allowedAnimals.includes("SQUIRREL");
    document.getElementById('animal-turtle').checked = 
        editor.state.editingLevel.allowedAnimals.includes("TURTLE");
...
// Toon bevestigingsdialoog voor verwijderen
...
// Verberg bevestigingsdialoog voor verwijderen
